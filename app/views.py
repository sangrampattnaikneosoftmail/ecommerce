...
from .models import Customer, Product, Cart, OrderPlaced, SubCategory
...
class ProductView(View):
    def get(self, request):
        ...
        data = {
			...
			'recommoneded_products':  products.filter(is_recommoned=True),
			'new_products': products.filter(is_new=True),
			# 'random_products': products.filter(is_new=False,is_trending=False,is_recommoned=False),
		}
...
class SubCategoryView(View):
    def get(self, request, slug):
        ...
        return render(
            request,
            "app/sub-category.html",
            {
                "products": Product.objects.filter(sub_category=sub_category),
				'recommoneded_products':  Product.objects.filter(is_recommoned=True),
